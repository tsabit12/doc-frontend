...
const FullnameInput = ({ onClose, defaultValue, onSave }) => {
    ...
    const onSubmit = () => {
        if(!fullname) return seterror(true);
                        ...
                        <Animated.View style={{ ...styles.content, transform }}>
                            <TouchableOpacity activeOpacity={1}>
                                <View style={styles.inputcontainer}>
                                    <Text style={{marginTop: 7, fontFamily: 'Poppins-Regular'}}>Enter your name</Text>
                                    <TextInput 
                                        ...
                                        value={fullname}
                                        selectTextOnFocus
                                        onChangeText={(text) => { setfullname(text); seterror(false) }}
                                        autoCapitalize='words'
                                    />
                                    { error && <Text style={styles.error}>Fullname is required</Text>}
                                    <View 
                                        style={{
                                            alignItems: 'flex-end', 
                                    ...
                                    >
                                        <View style={styles.footer}>
                                            <TouchableOpacity activeOpacity={0.7} onPress={() => onClose('fullname')}>
